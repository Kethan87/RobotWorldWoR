...
#define HAVE_BOOST_CHRONO_HPP 1
...
/* define if the wxWidgets 3.2.2. or higher is available */
...
/* Name of package */
#define PACKAGE "robotworld-0.2.0"

/* Define to the address where bug reports for this package should be sent. */
#define PACKAGE_BUGREPORT "J.Kraaijeveld@askesis.nl"

/* Define to the full name of this package. */
#define PACKAGE_NAME "robotworld"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "robotworld 0.2.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "robotworld-0.2.0"
